...
I write about Emacs, DocBook XSLT, Unix tools, Gentoo Linux, Mach-O, C/C++, OCaML, PL, Formal Proof (Coq), Type Theory and PLT. Despite CS, I may also writes about {{{ruby(アニメ,Anime)}}} and Galgames.
